...
THREE.BufferGeometryUtils = {
  computeTangents: function (geometry) {
    ...
    // based on http://www.terathon.com/code/tangent.html (per vertex tangents)
    if (index === null ||
        attributes.position === undefined ||
        attributes.normal === undefined ||
        attributes.uv === undefined) {

      console.warn('THREE.BufferGeometry: Missing required attributes ' +
                   '(index, position, normal or uv) in ' +
    ...
    if (attributes.tangent === undefined)
      geometry.addAttribute(
        'tangent', new THREE.BufferAttribute(
          new Float32Array(4 * nVertices), 4));
